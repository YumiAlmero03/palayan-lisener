...
commmands to check if biometrics can be connected to server

connect:biometric      Check one biometric
connect:biometrics     Reconnect to Biometrics
connect:biousers       Check one biometric users
